...
const FinanceV2Page = lazyWithRetry(() => import('./pages/FinanceV2').then(m => ({ default: m.FinanceV2Page })))
...
function AppContent() {
  ...
  const pageContent =
    ...
    (hasAccessToPage('finance') && currentPage === 'finance' && <FinancePage onNavigate={handleNavigate} />) ||
    (hasAccessToPage('finance') && currentPage === 'finance-v2' && <FinanceV2Page onNavigate={handleNavigate} />) ||
