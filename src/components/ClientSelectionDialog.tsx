        ...
        <Card className="p-2 sm:p-3 lg:p-4 bg-gray-50 border-gray-200">
          ...
          <div className="space-y-2 sm:space-y-2.5 lg:space-y-3">
            <div className="space-y-1">
              <Label htmlFor="csd-cin" className="text-xs sm:text-sm">رقم الهوية (CIN) *</Label>
              <Input
                id="csd-cin"
                type="text"
                value={cin}
            ...
            <div className="space-y-1">
              <Label htmlFor="csd-name" className="text-xs sm:text-sm">الاسم *</Label>
              <Input
                id="csd-name"
                value={name}
            ...
            <div className="space-y-1">
              <Label htmlFor="csd-phone" className="text-xs sm:text-sm">رقم الهاتف *</Label>
              <Input
                id="csd-phone"
                value={phone}
            ...
            <div className="space-y-1">
              <Label htmlFor="csd-email" className="text-xs sm:text-sm">البريد الإلكتروني</Label>
              <Input
                id="csd-email"
                type="email"
                value={email}
            ...
            <div className="space-y-1">
              <Label htmlFor="csd-address" className="text-xs sm:text-sm">العنوان</Label>
              <Input
                id="csd-address"
                value={address}
            ...
            <div className="space-y-1">
              <Label htmlFor="csd-type" className="text-xs sm:text-sm">النوع</Label>
              <select
                id="csd-type"
                value={clientType}
